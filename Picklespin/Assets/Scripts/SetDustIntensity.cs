...
public class SetDustIntensity : MonoBehaviour
{
    ...
    public void SetIntensity(float intensity)
    {
        ...
        sandParticleMain.startColor = new Color(sandParticleMain.startColor.color.r, sandParticleMain.startColor.color.g, sandParticleMain.startColor.color.b, currentIntensity * 6);
