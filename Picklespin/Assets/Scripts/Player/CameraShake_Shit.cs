...
public class CameraShake_Shit : MonoBehaviour
{
    public static CameraShake_Shit instance { get; private set; }
    ...
    public void EnemyHitShake(float shakeMultiplier)
    {
        mainCamera.DOShakeRotation(0.3f * shakeMultiplier, 20 * shakeMultiplier, 30, 90, true, ShakeRandomnessMode.Harmonic);
        //hand.DOShakePosition(0.2f * shakeMultiplier, 0.2f * shakeMultiplier, 40, 90, false, true, ShakeRandomnessMode.Harmonic);
    }
